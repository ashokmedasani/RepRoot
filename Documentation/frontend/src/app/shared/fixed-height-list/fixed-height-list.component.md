# frontend/src/app/shared/fixed-height-list/fixed-height-list.component.ts

## 2026-07-13 responsibilities

Defines the reusable approximately-five-row fixed-height container with internal vertical scrolling so record collections do not expand pages indefinitely.
