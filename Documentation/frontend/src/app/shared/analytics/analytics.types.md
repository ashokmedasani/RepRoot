# frontend/src/app/shared/analytics/analytics.types.ts

## 2026-07-13 responsibilities

Extends the existing reusable analytics engine and chart tooltip metadata so assigned-template graphs preserve value, submission date/time, and category context without duplicating calculations.
