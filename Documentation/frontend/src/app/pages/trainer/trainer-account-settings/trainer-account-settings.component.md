# frontend/src/app/pages/trainer/trainer-account-settings/trainer-account-settings.component.ts

## 2026-07-13 visual follow-up

Loads the trainer's existing code from the returned trainer_id field.

## 2026-07-13 responsibilities

Implements the unified Security page with trainer code, current/new/confirm password controls, and support-only trainer account deletion guidance.
