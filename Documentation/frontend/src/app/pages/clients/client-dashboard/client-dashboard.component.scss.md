# frontend/src/app/pages/clients/client-dashboard/client-dashboard.component.scss

## 2026-07-13 responsibilities

Implements the authenticated client dashboard with five KPIs, a fixed-height upcoming-schedule list, 24-hour urgency treatment, and assigned-template analytics grouped by template with empty graphs omitted. Graph groups flow at their natural page height without an internal scrollbar.
...
Adds red overdue rows/status badges, grouped schedule headings, and compact schedule-summary badges using existing theme tokens.
