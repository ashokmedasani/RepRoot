...
type AdminSection = 'dashboard' | 'finance' | 'audit';
...
@Component({
  ...
  template: `
    <div class="admin-shell">
      <aside class="admin-sidebar">
        <a class="admin-brand" routerLink="/admin-portal/dashboard"><span>CF</span><strong>CoachFlow</strong><small>Internal</small></a>
  ...
  styles: [`
    ...
    .admin-brand{display:grid;grid-template-columns:2.3rem 1fr;gap:0 .65rem;align-items:center;margin-bottom:2rem;color:var(--app-text);text-decoration:none}.admin-brand>span{grid-row:1/3;display:grid;width:2.3rem;height:2.3rem;place-items:center;border-radius:.7rem;background:var(--app-primary);color:white;font-weight:850}.admin-brand small{color:var(--app-muted);font-size:.68rem;text-transform:uppercase;letter-spacing:.12em}
