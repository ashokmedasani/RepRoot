...
import { FixedHeightListComponent } from '@workspace-shared/fixed-height-list/fixed-height-list.component';
...
import { chartTheme } from '@workspace-shared/analytics/charts/chart-theme';
